...
export const PROPERTIES: Property[] = [
  {
    ...
    gallery: [
      ...
      { src: "/images/mono_2.jpg", alt: "The Residence — facade detail" },
      { src: "/images/herobg3.jpg", alt: "The Residence — garden frontage" },
      { src: "/images/featured1.jpg", alt: "The Residence — interior view" },
      { src: "/images/side1.jpg", alt: "The Residence — terrace" },
      { src: "/images/exterior.png", alt: "The Residence — approach" },
    ],
  },
  {
    id: 2,
    ...
    gallery: [
      { src: "/images/interior_2.jpg", alt: "The Premier home — living space" },
      { src: "/images/mono_3.jpg", alt: "The Premier home — facade detail" },
      { src: "/images/herobg4.jpg", alt: "The Premier home — evening view" },
      { src: "/images/featured2.jpg", alt: "The Premier home — interior view" },
      { src: "/images/side2.jpg", alt: "The Premier home — terrace" },
      { src: "/images/interior-view.png", alt: "The Premier home — interior" },
    ],
  },
  {
    id: 3,
    ...
    gallery: [
      { src: "/images/interior_3.jpg", alt: "The Heights — living space" },
      { src: "/images/mono_4.jpg", alt: "The Heights — facade detail" },
      { src: "/images/herobg2.jpg", alt: "The Heights — aerial view" },
      { src: "/images/featured3.jpg", alt: "The Heights — interior view" },
      { src: "/images/mono2.jpg", alt: "The Heights — courtyard" },
      { src: "/images/philosophy.jpg", alt: "The Heights — landscape setting" },
    ],
  },
];
